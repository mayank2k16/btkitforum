...
<head>
 ...
 <link href="{{URL::to('assets')}}/vendors/bootgrid/jquery.bootgrid.min.css" rel="stylesheet">
    ...
    <header id="header" class="clearfix" style="background-color:#4CAF50">
        <ul class="header-inner">
            ...
            <li class="logo hidden-xs">
                <a href="{{URL::to('/dashboard')}}">F0rum Admin Page</a>
            </li>
                ...
                @else
                    <li class="dropdown">
                        <a data-toggle="dropdown" href="">
                            <span class="tm-label">{{ Auth::user()->name }}<span class="caret"></span> </span>
                        </a>
        ...
        <!--<div class="pm-body clearfix">
                            <ul class="tab-nav tn-justified">
                                <li class="active waves-effect list"><a href="{{url('/')}}">Registered Users</a></li>
                                <li class="waves-effect list"><a href="{{ url('orders') }}">Orders</a></li>
                                <li class="waves-effect list"><a href="{{ url('items')}}">Item list</a></li>
                                <li class="waves-effect list"><a href="{{ url('add_item')}}">Add Item</a></li>
                                <li class="waves-effect list"><a href="{{ url('feedbacks')}}">Feedbacks</a></li>
                            </ul>
...
<!--Start sidebar links -->
            <ul class="main-menu">
                ...
                <li><a href="{{ url('/users') }}"><i class="zmdi zmdi-accounts-list"></i>Customer list</a></li>

                <li class="sub-menu">

                    <a href=""><i class="zmdi zmdi-format-list-bulleted zmdi-hc-fw"></i>Mechants</a>
                    <ul>
                        <li><a href="{{ url('requests')}}"><i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></i>Show Requests</a></li>
                        <li><a href="{{ url('merchants')}}"><i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></i>Show Merchants</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul>
                        <li><a href="{{ url('orders') }}"><i class="zmdi zmdi-fullscreen zmdi-hc-fw"></i>See Orders</a></li>
                        <li><a href="{{ url('create/order')}}"><i class="zmdi zmdi-file-plus zmdi-hc-fw"></i> Create Order</a></li>
                    </ul>
                </li>

                <li><a href="{{ url('feedbacks') }}"><i class="zmdi zmdi-comments zmdi-hc-fw"></i>Feedbacks</a></li>
                <li><a href="{{ url('quotations') }}"><i class="zmdi zmdi-assignment zmdi-hc-fw"></i>Quotations</a></li>

                <li class="sub-menu">
                    <a href=""><i class="zmdi zmdi-storage zmdi-hc-fw"></i>Inventory</a>
                    <ul>

                        <li><a href="{{ url('items') }}"><i class="zmdi zmdi-check zmdi-hc-fw"></i> See Items</a></li>
                        <li><a href="{{ url('item/add') }}"><i class="zmdi zmdi-plus-square zmdi-hc-fw"></i> Add Item</a></li>
                        <li><a href="{{ url('combo')}}"><i class="zmdi zmdi-check-all zmdi-hc-fw"></i> See Combos</a></li>
                        <li><a href="{{ url('combo/add')}}"><i class="zmdi zmdi-plus-circle-o zmdi-hc-fw"></i> Add Combo</a></li>
                         <li><a href="{{ url('bulkitem')}}"><i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></i>Show Bulk Item</a></li>
                        <li><a href="{{ url('bulkprices')}}"><i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></i>Add Bulk Item</a></li>
                       </ul>
                </li>
                <li><a href="{{ url('discounts') }}"><i class="zmdi zmdi-alert-polygon zmdi-hc-fw"></i>Discount</a></li>
                <li><a href="{{ url('offers') }}"><i class="zmdi zmdi-label zmdi-hc-fw"></i>Offers</a></li>
                <li class="sub-menu">
                    <a href=""><i class="zmdi zmdi-washing-machine zmdi-hc-fw"></i>Referral</a>
                    <ul>
                        <li><a href="{{ url('referral/offers')}}"><i class="zmdi zmdi-labels zmdi-hc-fw"></i> Offers</a></li>
                        <li><a href="{{ url('referral/options')}}"><i class="zmdi zmdi-layers zmdi-hc-fw"></i> Swap Options</a></li>
                    </ul>
                </li>

                <li><a href="{{ url('promo') }}"><i class="zmdi zmdi-pin-assistant zmdi-hc-fw"></i>Promo codes</a></li>
...
<script src="{{URL::to('assets')}}/js/flot-charts/curved-line-chart.js"></script>
    ...
    <script src="{{URL::to('assets')}}/js/demo.js"></script>
     <script src="{{URL::to('assets')}}/vendors/bootgrid/jquery.bootgrid.updated.min.js"></script>
